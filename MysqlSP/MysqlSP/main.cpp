...
// 
// 
// 	ret = SQLConnect(hDbc, (SQLWCHAR*)L"MYODBC", SQL_NTS,
...
// 	//ret = SQLExecDirect(hStmt, (SQLWCHAR*)L"SELECT * FROM Users", SQL_NTS);
// 	ret = SQLExecDirect(hStmt, (SQLWCHAR*)L"call SP_SearchUID ('testId', 'asdf1234', @ret);", SQL_NTS);
// 		if (ret == SQL_SUCCESS) {
// 			int iCount = 0;
// 
